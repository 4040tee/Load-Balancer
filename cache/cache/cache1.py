...
def send_file_from_socket(clientsock,serversock, bytes_to_read):
        ...
        # We have the right request and version, so check if file exists.
            ...
            if (not os.path.exists(os.getcwd() + '/' + serverFolder + req_file)):
                ...
                if response_list[0].split(' ')[1] != '200':
                    ...
                    bytes_to_read = get_bytes_to_read(response_list)
                    send_file_from_socket(client_socket,conn, bytes_to_read)
